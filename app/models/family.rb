class Family < ApplicationRecord
  include PlaidConnectable, SimplefinConnectable, LunchflowConnectable, EnableBankingConnectable, Syncable, AutoTransferMatchable, AutoOffsetMatchable, Subscribeable
